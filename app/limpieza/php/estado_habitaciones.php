...
//Datos de conexión
	...
	$resultado="";
	$resultado.="<thead><tr><th>Numero de habitación</th><th>Tipo</th><th>Estado</th></tr></thead><tbody>";	
           ...
           <!-- Optionally, you can add icons to the links -->
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="#">Estado habitaciones</a></li>
				<li><a href="incidencias.php">Bitácora</a></li>
              </ul>
            </li>
          </ul><!-- /.sidebar-menu -->
        </section>
					...
					<div class="col-md-8">
					  <div class="box">
						<div class="box-header">
						  <h3 class="box-title">Lista habitaciones</h3>
						</div><!-- /.box-header -->
						<div class="box-body">
