...
//Datos de conexion
	...
	$resultado="";
	$resultado.="<thead><tr><th>Codigo tarifa</th><th>Nombre</th><th>Precio</th><th>Descripción</th></tr></thead><tbody>";	
	
	for($i=0;$i<$cols;$i++){
		$datos=mysqli_fetch_array($res);
		$resultado.="<tr>
						<td>".$datos['cod_tarifa']."</td>
           ...
           <!-- Optionally, you can add icons to the links -->
            <li class="treeview">
              ...
              <ul class="treeview-menu">
				...
				<li><a href="#">Consultar tarifas</a></li>
              </ul>
            </li>
          </ul><!-- /.sidebar-menu -->
        </section>
